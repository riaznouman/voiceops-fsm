...
Test-AdminGate -Email "nouman.riaz@cqumail.com"  -Password "Admin@1234"    -Label "ADMIN"
Test-AdminGate -Email "manager@voiceops.com"     -Password "Manager@1234"  -Label "MANAGER"
Test-AdminGate -Email "mehran.abbas@cqumail.com" -Password "Tech@1234"     -Label "TECHNICIAN"
Test-AdminGate -Email "12267110@cqumail.com"     -Password "Customer@1234" -Label "CUSTOMER"
